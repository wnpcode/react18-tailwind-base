...
import { setSessionStorage } from "@/configs/asyncSessionStorage";
...
export function SignIn() {
  ...
  const doLogin = async () => {
    ...
    try {
      ...
      let tokenData = await setSessionStorage("token", response.data.token);
      // try {
      ...
      let userData = await setSessionStorage(
        "login_data",
        JSON.stringify(responseCheck.data)
      );
      // } catch (error) {
      ...
      if ((validateRole("CASHIER"), "check kasir")) {
